...
var Customer = /** @class */ (function () {
    ...
    Customer.prototype.deployContract = function () {
        return __awaiter(this, void 0, void 0, function () {
            var name, compiled_name, abi, contract, first, last, contractCost;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        name = 'FairDelegation1';
                        ...
                        first = this.pkSp.substr(0, this.pkSp.length / 2);
                        last = this.pkSp.substr(this.pkSp.length / 2);
                        return [4 /*yield*/, contract.deploy({
                                data: contract.options.data,
                                arguments: ['0x' + first, '0x' + last]
                            }).estimateGas()];
                    case 1:
                        contractCost = _a.sent();
                        console.log("S1 - deploymentCost: " + contractCost);
                        return [4 /*yield*/, contract.deploy({
                                data: contract.options.data,
                                arguments: ['0x' + first, '0x' + last]
                            }).send({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    //     this.privateKey, enc
                    // );
                    return [4 /*yield*/, this.deployContract()];
                    case 1:
                        // const [workHash, enc, sig]: [string, string, string] = [
                        //     this.stamp[0], this.stamp[1], this.stamp[2]
                        // ]
