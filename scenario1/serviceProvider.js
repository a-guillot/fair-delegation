    ...
    function ServiceProvider(wage, sk, pk, addr, port, portOther, portBlockchain, portVerifier, ipOther, ipBlockchain, ipVerifier) {
        ...
        this.wsSp.on('connection', function (ws) {
            ...
            ws.on('messageAwait', function (msg, id) { return __awaiter(_this, void 0, void 0, function () {
                var _a, wsV_1, contractAddress, name_1, compiled_name, abi;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.sent();
                            if (!(this.input !== undefined)) return [3 /*break*/, 3];
                            this.work = 'Worked with:' + this.input;
                            _a = this;
                            return [4 /*yield*/, this.util.encrypt(this.publicKey, this.work)];
                        case 2:
                            _a.workEncrypted = _b.sent();
                            wsV_1 = new WebSocketAwait("ws://" + ipVerifier + ":" + portVerifier);
                            console.log("SP: opening connection with verifier");
                            wsV_1.on('open', function () { return __awaiter(_this, void 0, void 0, function () {
                                var waiting, stamp, ws2;
                                var _this = this;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, wsV_1.sendAwait({
                            ...
                            return [3 /*break*/, 5];
                        case 3:
                            contractAddress = msg.addr;
                            name_1 = 'FairDelegation1';
                            compiled_name = name_1 + '_sol_' + name_1;
