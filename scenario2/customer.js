            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log("S2 - deploymentCost: " + contractCost);
                        return [4 /*yield*/, contract.deploy({
                                data: contract.options.data,
                                arguments: []
                            }).send({
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.contract.methods.customer('0x' + first, '0x' + last).estimateGas()];
                    case 1:
                        _a.methodCost = _b.sent();
                        console.log("C.methodCost: " + this.methodCost);
                        return [4 /*yield*/, this.contract.methods.customer('0x' + first, '0x' + last).send({ from: this.address, value: this.web3.utils.toWei(this.wage.toString(), 'wei') }).on('error', console.error)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
